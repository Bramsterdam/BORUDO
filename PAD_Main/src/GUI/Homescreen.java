 ...
 * @author Iwan
 * 
 * This class creates a home screen for Borudo. From this screen users will have access to all functionalities and allows for a stand-by menu that users can access when they don't intend to use the product straightaway 
 */
